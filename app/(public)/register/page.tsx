...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-8rem)] w-full">
      ...
      <div className="relative hidden items-center justify-center overflow-hidden border-r border-white/5 bg-gradient-to-br from-[#0a0a0b] via-[#0a1a1a] to-[#0a0a0b] lg:flex lg:w-1/2">
        {/* Grid pattern */}
        <div
        ...
        <div className="relative z-10 max-w-md px-12 text-center">
          ...
          <div className="mx-auto mb-8 h-px w-16 bg-gradient-to-r from-transparent via-[#22d3ee]/50 to-transparent" />
          ...
          <div className="mt-12 rounded-lg border border-white/5 bg-white/[0.02] p-5 text-left">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div className="ml-auto text-xs text-[#84cc16]">Now</div>
            </div>
      ...
      <div className="flex w-full items-center justify-center px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-zinc-500">Start your interview prep journey today</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-zinc-600">
            ...
            <Link href="/login" className="text-[#84cc16] transition-colors hover:text-[#a3e635]">
              Sign in
            </Link>
          </p>
        </div>
