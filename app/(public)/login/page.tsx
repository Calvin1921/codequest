...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-8rem)] w-full">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0a0a0b] via-[#0f1a0a] to-[#0a0a0b] items-center justify-center border-r border-white/5">
        {/* Grid pattern */}
        ...
        <div className="relative z-10 max-w-md px-12 text-center">
          ...
          <div className="mb-8 mx-auto h-px w-16 bg-gradient-to-r from-transparent via-[#84cc16]/50 to-transparent" />
          ...
          <div className="mt-12 rounded-lg border border-white/5 bg-white/[0.02] p-4 text-left font-mono text-xs text-zinc-600 leading-relaxed">
            <div><span className="text-[#84cc16]/60">const</span> engineer = {'{'}</div>
            <div className="pl-4"><span className="text-[#22d3ee]/60">skills</span>: [<span className="text-[#84cc16]/60">&quot;solving&quot;</span>, <span className="text-[#84cc16]/60">&quot;growing&quot;</span>],</div>
            <div className="pl-4"><span className="text-[#22d3ee]/60">streak</span>: <span className="text-[#84cc16]/60">active</span>,</div>
            <div>{'}'}</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-6 text-center text-sm text-zinc-600">
            ...
            <Link href="/register" className="text-[#84cc16] hover:text-[#a3e635] transition-colors">
              Sign up
            </Link>
          </p>
        </div>
