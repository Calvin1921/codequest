...
async function SidebarUser() {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-1.5 rounded-md bg-lime-500/10 border border-lime-500/20 px-2.5 py-1.5">
...
export default async function AppLayout({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-60 flex-col border-r border-zinc-800/80 bg-zinc-950 md:flex">
        <div className="flex h-16 items-center gap-2 border-b border-zinc-800/80 px-5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-lime-500/15 border border-lime-500/30">
