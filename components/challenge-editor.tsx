...
export function ChallengeEditor({
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center gap-2 rounded-b-lg border border-t-0 border-neutral-800 bg-neutral-900/80 px-3 py-2">
        <button
          type="button"
          onClick={handleRun}
        ...
        <button
          type="button"
          onClick={handleReset}
          className="ml-auto flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm font-medium text-neutral-500 transition-colors hover:bg-neutral-800 hover:text-neutral-300"
        >
          <svg className="size-4" viewBox="0 0 20 20" fill="currentColor">
